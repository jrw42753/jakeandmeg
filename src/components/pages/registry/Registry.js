        ...
        <div className="registry-container">
            ...
            <div className="registry-flexbox-container">
                ...
                <div className="registry-flexbox-item" onClick={() => openRegistryLink("https://www.target.com/gift-registry/gift/megjake")}>
                    <img height="100px" src="https://firebasestorage.googleapis.com/v0/b/jakeandmeg.appspot.com/o/logos%2FTarget_Bullseye-Logo_Red_transparent-min.png?alt=media&token=3210db59-536d-48d5-995a-85242466b36c" className="registry-logo" />
            ...
            <div className="registry-flexbox-container">
                ...
                <div className="registry-flexbox-item" onClick={() => openRegistryLink("https://www.nfm.com/giftcards")}>
                    <img height="100px" src="https://firebasestorage.googleapis.com/v0/b/jakeandmeg.appspot.com/o/logos%2FNebraska_Furniture_Mart_logo-min.png?alt=media&token=d892438b-9be6-4fbe-aa9b-8dfc237d9d4f" className="registry-logo" />
                ...
                <div className="registry-flexbox-item" onClick={() => openRegistryLink("https://www.lowes.com/l/shop/gift-cards")}>
                    <img height="100px" src="https://firebasestorage.googleapis.com/v0/b/jakeandmeg.appspot.com/o/logos%2FLowes_logo_pms_280-min.png?alt=media&token=d23f87a1-f281-4630-a7d3-ec1e35bada5a" className="registry-logo" />
