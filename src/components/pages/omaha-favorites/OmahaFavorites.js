...
const OmahaFavorites = () => {
    ...
    return (
        <div className="page-container">
            <h1 className="omaha-title">Meg and Jake's Omaha&nbsp;Favorites</h1>
            <div className="omaha-container">
                <div className="omaha-item">
                    <h4 className="omaha-item-title">Henry Doorly Zoo</h4>
                    <img className="omaha-picture" src="https://firebasestorage.googleapis.com/v0/b/jakeandmeg.appspot.com/o/things-to-do%2FIMG_8239-min.jpg?alt=media&token=be178c7b-b738-4da9-af2e-d50bbcd5c462" />
                    <p className="omaha-description">The Omaha Zoo is THE best zoo in the world. You may think that's hyperbolic, but it's facts. Some of Jake and Meg's favorite dates take place here.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">The best buger in the world. Cheap & quick. Don't forget to sub chips with onion rings!</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Local coffee shop with coffee flights and good vibes.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Farm to cone. Favorite flavors: Ooey Gooey Blue St. Louis, Blackstone Butterbrickle, and Tart Cherry Crumble.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Meg's favorite brewery. They're always brewing up something creative. The Vanilla Bean Blonde is famous.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Wild farm to table american fusion street food. Great loaded fries too. Critics and casuals alike love Block 16.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Cheap and Delicious personal pizzas. Tons of toppings options.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Amazing vegan food. Mostly American dishes. Love their cauliflower wings.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">To-go falafels. Great vegitarian option. Make sure to get the seasoned fries too!</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Warren Buffett and Jake's favorite steak restaurant. Get the ribeye, prime rib, and spinach artichoke dip - Meg and Jake's favorites!</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Japenese ramen done right. Everything on the menu is to die for.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Retro arcade + pinball + huge on tap menu = a recipe for a fun time!</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Super tasty breakfast. Every plate has a creative twist.</p>
                ...
                <div className="omaha-item">
                    ...
                    <p className="omaha-description">Get your morning coffee here for a nice calm and inviting environment.</p>
                    <p><i class='fas fa-map-marker-alt' style={purpleStyle}></i>  8706 Pacific St, Omaha, NE 68114</p>
                    <p className="omaha-distance">10 minutes from <a href="/accommodations" style={purpleStyle}>Hampton&nbsp;La&nbsp;Vista</a></p>
                </div>
            </div>
        </div>
    )
